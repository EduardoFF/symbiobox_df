...
alias run_vstream="docker run -it --rm --name nccr_manet_vstream --net=host --privileged symbiobox/nccr_vstream video_stream.sh ${ID}"

alias run_vstream_st="docker run -d  --restart=always --name nccr_manet_vstream_st --net=host --privileged symbiobox/nccr_vstream video_stream.sh ${ID}"
